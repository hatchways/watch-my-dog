            ...
            <Grid container spacing={2}>
              <Grid item xs={12} sm={6}>
                <TextField
                  ...
                  InputProps={{classes: {notchedOutline: formErrors.firstName.length > 0 ? classes.error : ''}}}
                />
              ...
              <Grid item xs={12} sm={6}>
                <TextField
                  ...
                  autoFocus
                  onChange={handleChange}
                  InputProps={{classes: {notchedOutline: formErrors.lastName.length > 0 ? classes.error : ''}}}
                />
              ...
              <Grid item xs={12}>
                <TextField
                  ...
                  autoComplete="email"
                  onChange={handleChange}
                  InputProps={{classes: {notchedOutline: formErrors.email.length > 0 ? classes.error : ''}}}
                />
              ...
              <Grid item xs={12}>
                <TextField
                  ...
                  onChange={handleChange}       
                  InputProps={{classes: {notchedOutline: formErrors.password.length > 0 ? classes.error : ''}}}           
                />
